...
| TBD | `feat/provider-tf1plus-replace-wat` | Replace obsolete `plugins/wat` with `plugins/tf1plus` (`4.1.1-SNAPSHOT`): public GraphQL catalogue, optional local authenticated replay (disabled until configured), runtime `wat` grab-config alias |
