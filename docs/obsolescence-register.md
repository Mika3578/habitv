...
| `plugins/wat` | TF1/WAT-era URLs | `plugins/tf1plus` (TF1+ public catalog) | obsolete | Dedicated deprecation PR after `tf1plus` is in use | medium | — |
...
| RMC+ / RMC BFM Play | Full-channel BFM/RMC replay | None (protected Widevine) | protected | Maintainer-directed PR only | high | — |
