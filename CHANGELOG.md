...
| 2026-09-18 | TBD | Keep download-check daemon running after transient cycle failures (backoff + tray ERROR; stop only on shutdown) |
...
| TBD | `feat/provider-tf1plus-replace-wat` | Replace obsolete `plugins/wat` with `plugins/tf1plus` (`4.1.1-SNAPSHOT`): GraphQL catalogue, public download, runtime `wat` grab-config alias |
