...
final class IciToutTvDiagnostics {

	static final String STRATEGY = "nextjs-catalog-ytdlp";
	...
	IciToutTvDiagnostics(final String operation) {
	...
	String formatLogLine() {
		final StringBuilder line = new StringBuilder("provider=ICITOUTV");
