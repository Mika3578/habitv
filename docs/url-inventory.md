...
| `plugins/arte/src/com/dabi/habitv/provider/arte/ArteConf.java` | `https://www.arte.tv/fr/` | N/A | production-provider-url | updated | Updated public ARTE URLs to current HTTPS landing page. |
