...
| 2026-09-18 | TBD | Add `plugins/tf1plus` (TF1+ public GraphQL catalog, yt-dlp download) and `plugins/bfmtv` (BFMTV/BFM Business public replay catalog, yt-dlp download); document French replay coverage |
...
| Date | Commit | Change |
|------|--------|--------|
| 2026-09-18 | TBD | Record French replay platform research and new `tf1plus` / `bfmtv` plugins (`docs/french-replay-providers.md`) |
