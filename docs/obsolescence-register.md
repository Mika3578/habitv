...
| Canal+ `D17` | Legacy D17 channel naming | CStar sub-provider in `canalPlus` | obsolete | Graceful degrade + modern catalog parsers; DRM download unavailable | medium | #91, #180 |
