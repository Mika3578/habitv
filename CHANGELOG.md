...
| TBD | `feat/provider-tf1plus-replace-wat` | Replace obsolete `plugins/wat` with `plugins/tf1plus` (`4.1.1-SNAPSHOT`): GraphQL catalogue, optional protected download when configured, runtime `wat` grab-config alias; marked working after local E2E |
