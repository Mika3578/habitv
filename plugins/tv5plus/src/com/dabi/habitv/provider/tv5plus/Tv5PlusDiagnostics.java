...
final class Tv5PlusDiagnostics {

	static final String STRATEGY = "graphql-catalog-ytdlp";
	...
	Tv5PlusDiagnostics(final String operation) {
	...
	String formatLogLine() {
		final StringBuilder line = new StringBuilder("provider=TV5PLUS");
