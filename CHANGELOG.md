...
| Date | Commit | Change |
|------|--------|--------|
| 2026-09-18 | PR [#180](https://github.com/Mika3578/habitv/pull/180) | Canal+ modern catalog parsing (hodor/page fixtures), home-page category discovery, visible unavailable placeholders, canonical episode metadata, and honest DRM-blocked download; bump `canalPlus` to `4.1.1-SNAPSHOT` |
...
| Date | Commit | Change |
|------|--------|--------|
| 2026-09-18 | PR [#180](https://github.com/Mika3578/habitv/pull/180) | Add Canal+ offline fixtures and parser tests for modern catalog payloads, home-page discovery, and DRM-blocked download |
